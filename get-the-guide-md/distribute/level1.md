# 배포수준: 설치 스크립트 구동, 호스트 당 멀티 서비스 인스턴스


## 원칙
- 설치 스크립트 구동 및 호스트 당 멀티 서비스 인스턴스를 적용함
- 설치 스크립트: 서비스 인스턴스를 설치하고 구성하기 위한 자동화된 스크립트를 사용함
- 호스트 당 멀티 서비스 인스턴스: 단일 호스트에서 여러 개의 서비스 인스턴스를 실행하여 확장성을 향상함
