# 팀 구조와 문화: 공유된 서비스 모델로 팀 공동 작업 내부 소스 공개


## 원칙
- 공유된 서비스 모델로 팀 공동 작업, 내부 소스 공개를 적용함
- 공유된 서비스 모델: 여러 팀이 공통적으로 사용하는 서비스 모델을 개발하고 유지보수하여 효율성을 향상함
- 팀 공동 작업: 여러 팀이 협업하여 기능을 개발하고 통합하는 작업을 수행함
- 내부 소스 공개: 팀 내에서 개발된 소스 코드와 지식을 공유하고 문서화하여 효율적인 협업을 도모함
